...
from src.data.components.chain_dataset import ChainDataset


class ChainDataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str,
    ...
    def setup(self, stage: str) -> None:
        dataset = ChainDataset(
            ...
            name_for_chain_data=self.hparams.name_for_chain_data,
...
if __name__ == '__main__':
    data_module = ChainDataModule(
        ...
        name_for_chain_data='2023-06-22-14-13-18-graph.csv',
        raw_dir='raw',
        save_dir='processed',
        num_time_step=5,
